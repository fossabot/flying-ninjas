...
// Default values
        ...
        var _modulesDefaultParams2 = _interopRequireDefault(
            _modulesDefaultParams);
        ...
        exports['default'] = sweetAlert = swal = function() {
          ...
          function argumentOrDefault(key) {
            ...
            return args[key] === undefined ?
                _modulesDefaultParams2['default'][key] :
                args[key];
          }
          ...
          var params = (0, _modulesUtils.extend)({},
              _modulesDefaultParams2['default']);
        ...
        sweetAlert.close = swal.close = function() {
          ...
          (0, _modulesHandleDom.fadeOut)(
              (0, _modulesHandleSwalDom.getOverlay)(), 5);
          ...
          (0, _modulesHandleDom.removeClass)(
              $successIcon.querySelector('.sa-tip'), 'animateSuccessTip');
          (0, _modulesHandleDom.removeClass)(
              $successIcon.querySelector('.sa-long'), 'animateSuccessLong');

          var $errorIcon = modal.querySelector('.sa-icon.sa-error');
          (0, _modulesHandleDom.removeClass)($errorIcon, 'animateErrorIcon');
          (0, _modulesHandleDom.removeClass)(
              $errorIcon.querySelector('.sa-x-mark'), 'animateXMark');

          var $warningIcon = modal.querySelector('.sa-icon.sa-warning');
          (0, _modulesHandleDom.removeClass)($warningIcon, 'pulseWarning');
          (0, _modulesHandleDom.removeClass)(
              $warningIcon.querySelector('.sa-body'), 'pulseWarningIns');
          (0, _modulesHandleDom.removeClass)(
              $warningIcon.querySelector('.sa-dot'), 'pulseWarningIns');
      ...
      function(require, module, exports) {
        ...
        var handleButton = function handleButton(event, params, modal) {
          ...
          var targetedOverlay = target.className.indexOf('sweet-overlay') !==
              -1;
          ...
          switch (e.type) {
            ...
            case 'click':
              ...
              var clickedOnModalChild = (0, _handleDom.isDescendant)(modal,
                  target);

              // Ignore click outside if allowOutsideClick is false
              if (!clickedOnModal && !clickedOnModalChild && modalIsVisible &&
              ...
              } else if ((0, _handleDom.isDescendant)(modal, target) &&
        ...
        var handleCancel = function handleCancel(modal, params) {
          ...
          var functionHandlesCancel = functionAsStr.substring(0, 9) ===
              'function(' && functionAsStr.substring(9, 10) !== ')';
      ...
      }, {'./handle-dom': 4, './handle-swal-dom': 6, './utils': 9}], 4: [
      function(require, module, exports) {
        'use strict';
        ...
        var getTopMargin = function getTopMargin(elem) {
          ...
          if (typeof getComputedStyle !== 'undefined') {
            // IE 8
            padding = parseInt(
                getComputedStyle(elem).getPropertyValue('padding-top'), 10);
          } else {
        ...
        var fadeIn = function fadeIn(elem, interval) {
          if (+elem.style.opacity < 1) {
            ...
            var tick = function tick() {
              elem.style.opacity = +elem.style.opacity +
                  (new Date() - last) / 100;
              last = +new Date();
        ...
        var handleKeyDown = function handleKeyDown(event, params, modal) {
          ...
          if (keyCode === 9) {
            ...
            if (params.confirmButtonColor) {
              (0, _handleSwalDom.setFocusStyle)($targetElement,
      ...
      }, {'./handle-dom': 4, './handle-swal-dom': 6}], 6: [
      function(require, module, exports) {
        'use strict';
...
// End of modal
        ...
        var setParameters = function setParameters(params) {
            ...
            var _ret = (function() {
              ...
              switch (params.type) {
                ...
                case 'success':
                  ...
                  (0, _handleDom.addClass)($icon.querySelector('.sa-tip'),
                      'animateSuccessTip');
                  (0, _handleDom.addClass)($icon.querySelector('.sa-long'),
                      'animateSuccessLong');
                  break;

                case 'error':
                  (0, _handleDom.addClass)($icon, 'animateErrorIcon');
                  (0, _handleDom.addClass)($icon.querySelector('.sa-x-mark'),
                      'animateXMark');
                  break;

                case 'warning':
                  (0, _handleDom.addClass)($icon, 'pulseWarning');
                  (0, _handleDom.addClass)($icon.querySelector('.sa-body'),
                      'pulseWarningIns');
                  (0, _handleDom.addClass)($icon.querySelector('.sa-dot'),
                      'pulseWarningIns');
                  break;
          ...
          if (params.imageUrl) {
            ...
            $customIcon.setAttribute('style',
                $customIcon.getAttribute('style') + 'width:' + _imgWidth +
                'px; height:' + _imgHeight + 'px');
          }
           ...
           * Show confirm button?
           */
          modal.setAttribute('data-has-confirm-button',
          ...
          if (params.confirmButtonColor) {
            ...
            (0, _handleSwalDom.setFocusStyle)($confirmBtn,
                params.confirmButtonColor);
          }
           ...
           * Allow outside click
           */
          modal.setAttribute('data-allow-outside-click',
              params.allowOutsideClick);
      ...
      }, {'./handle-dom': 4, './handle-swal-dom': 6, './utils': 9}], 9: [
      function(require, module, exports) {
        /*
